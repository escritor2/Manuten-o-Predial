 ...
 * @route '/livewire-8a926147/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-8a926147/upload-file',
 ...
 * @route '/livewire-8a926147/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-8a926147/preview-file/{filename}',
