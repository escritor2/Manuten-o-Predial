 ...
 * @route '/livewire-96416411/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-96416411/upload-file',
 ...
 * @route '/livewire-96416411/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-96416411/preview-file/{filename}',
